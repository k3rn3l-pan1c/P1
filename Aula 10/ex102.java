 ...
 * Do Stats 7.3
 * 
 * alterado para ler do ficheiro
 * nao le do terminal, pede ficheiro ao user
 * 
 */
...
public class ex102 {
  ...
  public static void main(String[] args) throws IOException{
	 ...
	 File Ficheiro = new File(name);
	 Scanner readFile = new Scanner(Ficheiro); //my scanner:  vai ler os dados do file
	...
	public static void updateStats(Statistics xstat, int x){
